...
public class CpuList extends BaseTable implements TableOperations {
    ...
    public void createTable() throws SQLException, ClassNotFoundException {
        super.executeSqlStatement("CREATE TABLE IF NOT EXISTS cpu_list(" +
                ...
                "    cores smallint NOT NULL);", "Обновлена таблица " + tableName);
    }
    @Override
    public void insertBaseDate(String sql) throws SQLException, ClassNotFoundException {
    }

    public void addCpu(String name, String manufacturer, int generation, double frequency, int cores) throws SQLException, ClassNotFoundException {
        reopenConnection();
        PreparedStatement ps = connection.prepareStatement("INSERT INTO cpu_list (name, manufacturer, generation, frequency, cores) VALUES (?, ?, ?, ?, ?);");
        ps.setString(1, name);
